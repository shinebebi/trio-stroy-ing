...
const products = [
    {
        id: 1,
        imgSource: staticImages.product1,
        title: "Линза Ж2-100 ст.30ХМА ГОСТ 10493-81",
        brand: "Регионгаздеталь",
        price: 123.0,
        category: 'prod_filter_1'
    },
    {
        id: 2,
        imgSource: staticImages.product2,
        title: "Колено трубы 67,5° диам.80 REGENAU Медный",
        brand: "ТД Кровля и Фасад",
        price: 123.0,
        category: 'prod_filter_1'
    },
    {
        id: 3,
        imgSource: staticImages.product3,
        title: "Установка для очистки атмосферных и поверхностных сточных вод открытого типа ТОПРЕЙН 4",
        brand: "ТОПОЛ-ЭКО УРАЛ",
        price: 123.0,
        category: 'prod_filter_2'
    },
    {
        id: 4,
        imgSource: staticImages.product4,
        title: "Кран для газа шаровый ТК-GAS Внутренняя/наружная резьба 3/4\" \"бабочка\"",
        brand: "Гидротехника",
        price: 123.0,
        category: 'prod_filter_3'
    },
    {
        id: 5,
        imgSource: staticImages.product5,
        title: "Кран шаровый для газа ТК-GAS В-В 3/4\" бабочка",
        brand: "Гидротехника",
        price: 123.0,
        category: 'prod_filter_3'
    },
    {
        id: 6,
        imgSource: staticImages.product6,
        title: "Клапан поплавковый для ёмкости 1\" ш 150 мм, TIM",
        brand: "Гидротехника",
        price: 123.0,
        category: 'prod_filter_4'
    },
    {
        id: 7,
        imgSource: staticImages.product7,
        title: "Клапан поплавковый для ёмкости 3/4\" ш Candan",
        brand: "Гидротехника",
        price: 123.0,
        category: 'prod_filter_4'
    },
...
const ProductFilterList = [
    {
        id: "prod_filter_1",
        title: "Фасонные чати трубопроводов",
    },
    {
        id: "prod_filter_2",
        title: "Канализация",
...
const servicesData = [
    {
        ...
        text: "Готово к отправке в течение 4-7 рабочих дней",
    },
    {
        id: "service_4",
        icon: staticImages.return_icon,
        text: "Доставляем за свой счет до вашего города",
    },
];
...
const productDescriptionTabHeads = [
    ...
    },
    {
        id: "tab-comments",
        tabHead: "tabComments",
        tabText: "Комментарии пользоватлеей",
        badgeValue: 10,
        badgeColor: "purple",
    },
    {
